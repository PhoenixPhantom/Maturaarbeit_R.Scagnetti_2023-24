...
void UStatsMonitorBaseWidget::UpdateHealth(int32 NewHealth, int32 OldHealth)
{
...
void UStatsMonitorBaseWidget::UpdateMaxHealth(int32 CurrentHealth, int32 NewMaxHealth)
{
	check(IsValid(HealthBar));
